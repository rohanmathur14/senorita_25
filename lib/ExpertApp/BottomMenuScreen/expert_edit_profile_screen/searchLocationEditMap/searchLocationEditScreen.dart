                            ...
                            child: GestureDetector(
                              ...
                              child:TypeAheadField<Prediction>(
                                ...
                                onSelected: (Prediction suggestion) async {
                                  controller.mapControllerText.text = suggestion.description ?? '';
                                  controller.getLatLngFromPlaceId(suggestion.placeId.toString());
                                  controller.address.value = suggestion.description ?? '';
                                },
                                builder: (context, controller, focusNode) {
                                  return TextField(
                                    controller: this.controller.mapControllerText,
                                    focusNode: focusNode,
